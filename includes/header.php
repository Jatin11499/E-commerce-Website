<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
	<div class="container-fluid">
		<div class="navbar-header">
			<a href="index_page.php" class="navbar-brand" style="padding-left:50px;">Lifestyle Store</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="cn">
			<ul class="nav navbar-nav ml-auto">
				...
				<?php }
					...
					<li class="nav-item" style="padding-right:50px;"><a class="nav-link" href="login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
				<?php } ?>
			</ul>
		</div>
	</div>	
